...
<div class="w-full h-screen flex items-center justify-center">
    <div class="border border-foreground-muted rounded-md px-4 py-2 w-96">
        <div class="pb-5">
            <h4 class="font-titles text-2xl">Create Your Account</h4>
            <small class="font-body text-foreground-muted">You will only be able to complete this process if you are a <span class="text-foreground font-medium">BobaLUG Member</span>.</small>
        </div>
